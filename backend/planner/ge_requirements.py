...
INDEPENDENT_FULL_SUPPORT_IDS = {209, 213, 217, 220}

INDEPENDENT_LOW_CONFIDENCE_IDS = {206, 215, 228}

INDEPENDENT_UNSUPPORTED_IDS = {
    201, 204, 205, 207, 208, 210, 211, 212, 214, 216,
    218, 219, 222, 224, 225, 227, 229, 230, 231, 232,
    233, 234, 235, 236,
}
