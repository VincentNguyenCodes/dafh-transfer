...
const STEPS = [
  { num: 1, label: 'Add Your Transcripts', desc: 'Paste your De Anza and Foothill transcripts', path: '/transcript', icon: '📄' },
  { num: 2, label: 'Choose Schools & Majors', desc: 'Select which schools and majors you are applying to', path: '/schools', icon: '🎓' },
  { num: 3, label: 'View Your Results', desc: 'See which classes you still need to take', path: '/results', icon: '✅' },
]
