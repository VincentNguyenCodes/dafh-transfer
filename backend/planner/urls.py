...
from .views import BestScheduleView, ChatView, OptionPreferenceView, PrerequisitesView, ProgressView, ResultsView, ScheduleDetailView, ScheduleListView, TransferTargetDetailView, TransferTargetView
...
urlpatterns = [
    ...
    path('prerequisites/', PrerequisitesView.as_view(), name='prerequisites'),
